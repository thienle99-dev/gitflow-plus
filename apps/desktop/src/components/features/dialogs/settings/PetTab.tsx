...
export function PetTab({ petEnabled, setPetEnabled, petType, setPetType }: PetTabProps) {
  return (
    <div className="space-y-4">
      <div id="pet-toggle" className="bg-surface-1-30 border border-border-40 rounded-mac p-3.5">
        <Switch
          checked={petEnabled}
      ...
      <div id="pet-selector" className={!petEnabled ? "opacity-45 pointer-events-none" : undefined}>
